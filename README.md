# Update to Forked Project

This is an updated repo for the Udacity ML-Ops nano degress.  The code in this repo has been released as a runable package.

You can find the artifacts for this ML pipeline on Weights and Biases using the link below:

[https://wandb.ai/bryantravissmith/nyc_airbnb](https://wandb.ai/bryantravissmith/nyc_airbnb)

The code that produces these artfiacts can be found in this repo:

[https://github.com/bryantravissmith/build-ml-pipeline-for-short-term-rental-prices](https://github.com/bryantravissmith/build-ml-pipeline-for-short-term-rental-prices)
